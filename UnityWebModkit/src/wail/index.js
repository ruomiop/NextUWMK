...
const ARG_TABLE_SIZE = 0x10;
const ARG_TABLE_FILL = 0x11;
...
export class WailParser extends BufferReader {
  ...
  _readSection() {
    ...
    // DataCount and Tag sections violate the usual rule that non-custom sections
    // occur in numeric order. Do not infer earlier sections are missing from them.
